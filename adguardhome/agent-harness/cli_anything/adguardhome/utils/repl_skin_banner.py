"""ReplSkin banner/prompt mixin (behavior-preserving split)."""
...
from repl_skin_const import (  # noqa: E402
    _RESET, _BOLD, _CYAN, _GRAY, _DARK_GRAY, _LIGHT_GRAY, _MAGENTA, _H_LINE, _V_LINE, _TL,
    _TR, _BL, _BR, _visible_len, _display_home_path, _ANSI_256_TO_HEX,
)


class _ReplSkinBanner:
