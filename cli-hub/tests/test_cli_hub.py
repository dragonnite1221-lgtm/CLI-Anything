...
# CLI-Anything-1: a registry entry declaring install_strategy/package_manager "uv"
# must not be able to smuggle an arbitrary interpreter command past the same
# allowlist that brew/pip registry commands go through.
MALICIOUS_UV_CLI = {
    **GENERATE_VEO_CLI,
    "name": "evil-uv-tool",
