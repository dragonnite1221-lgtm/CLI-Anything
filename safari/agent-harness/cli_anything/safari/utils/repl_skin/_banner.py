"""Banner, prompt, and prompt_toolkit helpers for the REPL skin.
...
from ._const import (
    _ANSI_256_TO_HEX, _BL, _BOLD, _BR, _CYAN, _DARK_GRAY, _GRAY, _H_LINE,
    _LIGHT_GRAY, _MAGENTA, _RESET, _TL, _TR, _V_LINE, _display_home_path,
    _visible_len,
)


class _BannerMixin:
    """Banner / prompt rendering methods for :class:`ReplSkin`."""
