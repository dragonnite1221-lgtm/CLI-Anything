...
# fmt: off
from .preview_p2 import capture  # noqa: E402,E501
from .preview_p3 import _live_session_dir, _now_iso, _pid_is_running, _read_json, _terminate_pid, _with_live_refs, _write_json  # noqa: E402,E501
...
def live_stop(
    ...
    *,
    ...
    _write_json(
        session_path, {k: v for k, v in payload.items() if not k.startswith("_")}
    )
