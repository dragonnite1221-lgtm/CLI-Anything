...
# fmt: off
from .preview_p3 import _load_existing_live_session, _now_iso, _project_file_fingerprint, _write_live_session_updates  # noqa: E402,E501
    ...
    try:
        ...
        live_payload = live_start(
            ...
            command=str(
                ...
                or f"cli-anything-shotcut preview live monitor --session-dir {session_path}"
            ),
